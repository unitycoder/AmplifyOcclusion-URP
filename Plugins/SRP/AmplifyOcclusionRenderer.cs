    ...
    public class AmplifyOcclusionRenderer : ScriptableRendererFeature
    {
        ...
        class AmplifyOcclusionRenderPass : ScriptableRenderPass
        {
            ...
            bool Prepare(CommandBuffer cmd, PassData d)
            {
                ...
                cmd.SetGlobalFloat("_RenderViewportScaleFactor", 1.0f);
            ...
            void Render(CommandBuffer cmd, RenderTargetIdentifier src, RenderTargetIdentifier dst)
            {
                ...
                if (settings.ApplyMethod.value == AmplifyOcclusionVolume.ApplicationMethod.Debug)
                    commandBuffer_FillApplyDebug(cmd, src, dst);
                else
                    commandBuffer_FillApplyPostEffect(cmd, src, dst);
            ...
            class PassData
            {
                public AmplifyOcclusionRenderPass pass;
